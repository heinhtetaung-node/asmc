...
var getColumns = function () {
    return [
		...
		{title: "Expenses1", dataKey: "expenses1"},
		{title: "Expenses2", dataKey: "expenses2"},
		{title: "Expenses3", dataKey: "expenses3"},
...
function getData(rowCount) {
    ...
    for (var j = 1; j <= rowCount; j++) {
        data.push({
			...
			expenses1: faker.finance.amount(),
			expenses2: faker.finance.amount(),
			expenses3: faker.finance.amount(),
